...
// Names of every icon used across the survey dashboard frame.
...
// Material-style icon path data (24x24 viewBox). One `d` string per icon
// (multiple subpaths combined). Fill uses currentColor so the parent's
// `color` controls the icon color — matching the Figma semantic colors.
const ICONS: Record<IconName, string> = {
  ...
  assessment:
    'M5 9.2h3V19H5V9.2zm5.6-5.2h2.8v15h-2.8V4zm5.6 8H19v7h-2.8v-7z',
  'more-vert':
...
// Renders a single Material-style icon as inline SVG.
// Size defaults to 24px; color is inherited via currentColor.
@Component({
  selector: 'app-icon',
  standalone: true,
...
export class IconComponent {
  ...
  // Resolve the path data for the requested icon name.
